 ...
 * @since [ HG ] W 1.0
/*
Template Name: Cadastro Prescritor
*/
acf_form_head();
get_header('zero');
?>
...
<div id="toast-success" class="flex items-center w-full max-w-full p-4 mb-4 text-green-600 bg-green-200 rounded-lg shadow" role="alert">
    ...
    <div class="ms-3 text-sm font-normal">Prescritor cadastrado com sucesso.</div>
...
<form action="" enctype="multipart/form-data" method="POST">
    <?php wp_nonce_field('add_prescritor_action', 'add_prescritor_nonce'); ?>
...
<div class="mb-5 card card-layout-frame">
    <div class="card-body">    
        <div class="flex justify-between space-x-2 uppercase font-semibold text-zinc-900">
            <div>
                <h3 class="mb-1 text-lg font-medium text-gray-900 uppercase">Cadastro de Prescritor</h3>                      
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
          ...
          <div class="grid gap-4 sm:grid-cols-4 sm:gap-4 mb-4">
              ...
              <div class="sm:col-span-2">
                  ...
                  <input type="text" name="acf[field_66e5c2cd553d3]" id="nome_completo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" placeholder="Nome completo do Prescritor" required="">
              </div>

                <div class="w-full">
                    <label for="email_prescritor" class="block mb-2 text-sm font-medium text-gray-900">E-mail *</label>
                    <input type="text" name="acf[field_66e6494ba7957]" id="email_prescritor" class="email-temp bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" placeholder="E-mail Prescritor" required />
                </div>

                <div class="w-full">
                    <label for="telefone_prescritor" class="block mb-2 text-sm font-medium text-gray-900">Whatsapp *</label>
                    <input type="text" name="acf[field_66e649d3ab0e1]" id="telefone_prescritor" class="email-temp bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" placeholder="Whatsapp Prescritor" required />
                </div>
        ...
        <div class="grid gap-4 sm:grid-cols-4 sm:gap-4 mb-4">
              ...
              <div class="w-full">
                  ...
                  <input type="text" name="acf[field_66ed849450332]" id="cpf_prescritor" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" placeholder="CPF" required="">
              </div>
              ...
              <div class="w-full esconde-tutor">
                  ...
                  <input type="text" name="acf[field_66e64bf206275]" id="n_id_prescritor" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" placeholder="Documento de identificação do conselho" required="">
              </div>   

              <div class="w-full">
                  <label for="estado_id_conselho" class="block mb-2 text-sm font-medium text-gray-900">Estado *</label>
                  <input type="text" name="acf[field_66e5c2fc553d5]" id="estado_id_conselho" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" placeholder="Estado" required="">
              </div>

              <div class="w-full">
                  <label for="especialidade" class="block mb-2 text-sm font-medium text-gray-900">Especialidade *</label>
                  <input type="text" name="acf[field_66e5c319553d6]" id="especialidade" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" placeholder="Especialidade" required="">
              </div>
...
-->
              ...
              <div class="col-start-1 sm:col-span-4">
                    ...
                    <textarea id="curriculo" name="acf[field_66e5c320553d7]" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500" placeholder="Digite aqui..."></textarea>
              </div>

              <div class="col-start-1 sm:col-span-4">
                    <label for="infos_consulta" class="block mb-2 text-sm font-medium text-gray-900">Informações da Consulta</label>
                    <textarea id="infos_consulta" name="acf[field_6708f0ed66b80]" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500" placeholder="Digite aqui..."></textarea>
              </div>
              ...
              <div class="w-full">
                  ...
                  <input type="text" name="acf[field_6708f10766b81]" id="valor_consulta" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" placeholder="R$" required="">
              </div>
    ...
    <div class="w-full">
        ...
        <input type="hidden" id="foto_site_url" name="foto_site_url">
                ...
                <div class="flex items-center me-4 ps-4 py-4 border border-gray-200 rounded bg-green-50">
                    ...
                    <label for="concorda" class="ms-2 text-sm font-medium text-gray-900">Declaro que estou de acordo com o presente termo associativo e que todos os dados informados são verdadeiros. <a href="#!/termo-de-adesao/" class="text-blue-600 dark:text-blue-500 hover:underline">Saiba Mais</a></label>
                </div>
            ...
            <div id="stickyFooter_" class="w-full mt-5 px-6 flex items-center border border-gray-300 justify-between py-4 bg-white rounded-lg">
                ...
                <div class="md:flex items-center">
                    ...
                    <button class="btn btn-sm bg-green-500 text-white hover:opacity-50" type="submit" name="submit_prescritor_form">
